export const categories = [
  {
    id: 1,
    name: "Marketing",
    icon: <i className="fa fa-3x fa-mail-bulk text-primary mb-4"></i>,
    vacant: 234,
  },
  {
    id: 2,
  ...
  },
  {
    ...
    icon: <i className="fa fa-3x fa-hands-helping text-primary mb-4"></i>,
    vacant: 234,
  },
  {
    id: 5,
    name: "Project Management",
    icon: <i className="fa fa-3x fa-tasks text-primary mb-4"></i>,
    vacant: 234,
  },
  {
    id: 6,
    name: "Computer Engineering",
    icon: <i className="fa fa-3x fa-drafting-compass text-primary mb-4"></i>,
    vacant: 1004,
  },
  {
    id: 7,
    name: "Teaching & Education",
    icon: <i className="fa fa-3x fa-book-reader text-primary mb-4"></i>,
    vacant: 1004,
  },
  {
    id: 8,
